...
- [x] Autodiff delta, vega, rho; forward vs reverse mode (E1)
- [x] Finite-difference baseline, CRN and independent seeds, with bootstrap CIs (E2)
- [x] Gamma: naive AD vs LR vs pathwise-LR vs smoothing, with bootstrap CIs (E3, E4)
...
- **Random-number generation dominates the price.** It is 58% of basket pricing flops
  ...
  pricing. The "x one pricing" ratios elsewhere in this README (E1, E6, and the memory
